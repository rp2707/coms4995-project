...
"""
Usage Examples:
    [1] python 3dgan_mit_biasfree.py --name biasfree_tfbn
    [2] python 3dgan_mit_biasfree.py --ckpath models/biasfree_tfbn.ckpt-100
    generating new objects:
    [3] python 3dgan_mit_biasfree.py --train False --ckpath models/biasfree_tfbn.ckpt-10400
    
    interpolating given zvectors:
    [4] python 3dgan_mit_biasfree.py --train False --ckpath models/biasfree_tfbn.ckpt-10400 --interpolatd_zs interpolated_airplanes_61_37.npy
"""
#import scipy
import pickle
